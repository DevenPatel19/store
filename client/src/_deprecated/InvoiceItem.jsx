    ...
    <div className="bg-white/5 rounded-lg p-4 space-y-3">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-3">
        ...
        <div>
          ...
          <input
            ...
            readOnly
            className="w-full p-2 rounded-lg bg-white/10 border border-white/30 text-white cursor-not-allowed text-sm"
      ...
      <div className="text-right">
        <span className="text-sm text-gray-300">
          Amount: <span className="font-semibold text-white">${(item.quantity * item.rate).toFixed(2)}</span>
        </span>
      </div>
    </div>
  );
